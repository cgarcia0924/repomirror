...
//const urlgrabacones="https://ze9l39fzei.execute-api.us-east-1.amazonaws.com/dev/"
...
class Home extends React.Component {
  ...
  ArmaWup(Usuariojson, queuidjson, Wrapujson, dnissonp, rangofecha) {
    ...
    if (queuidjson.length === 0) {
      alert('Es obligatoria la selección de una cola');
    ...
    if (dato.Estado === 'PROCESAR' || dato.Estado === 'FULFILLED') {
      ...
      try {
        ...
        var config = {
          ...
          url:
            urlgrabacones +
            'gets3CorversationDetailsQueryJobs/' +
            dato.job_id +
            '/' +
            dato.Fecha,
